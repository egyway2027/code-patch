...
export default function CodePatcher(){
 ...
 return <main style={{minHeight:'100vh',background:C.bg,color:C.text,fontFamily:'system-ui,sans-serif',padding:'14px 10px',direction:rtl?'rtl':'ltr',width:'100%',overflowX:'hidden'}}><div style={{maxWidth:1400,margin:'auto',width:'100%'}}>
