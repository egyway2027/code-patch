...
async function deleteRecord(id){try{await fs.rm(path.join(JOURNAL_DIR,`${id}.json`),{force:true});await fs.rm(path.join(JOURNAL_DIR,id),{recursive:true,force:true});}catch{}}
